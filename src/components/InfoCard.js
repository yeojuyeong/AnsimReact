    ...
    return (
        <div className="card_layout" onClick={(e) => {handleCardClick(index, e)}}>
            ...
            <div className="card_addr">
                <span
                    style={{ color: '#817C7C', backgroundColor: '#fff', borderRadius: '10px', padding: '3px', fontSize: '8px', fontWeight: 'bold' }}>
                    지번</span>
                <span
            ...
            {data.police_conn_yn && (
                ...
                <span
                    ...
                    <span
                        style={{ color: '#817C7C', backgroundColor: '#fff', borderRadius: '10px', padding: '3px', fontSize: '8px', marginLeft: '4px', fontWeight: 'bold' }}>
                    관할</span>
                    <span
                        style={{ fontSize: '10px', marginLeft: '10px' }}>
                    {data.mng_org}</span>
